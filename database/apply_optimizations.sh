...
if [ ! -f "database/performance_optimization.sql" ]; then
    log_error "Файл database/performance_optimization.sql не найден!"
    exit 1
fi
...
echo "4. Скопируйте и вставьте содержимое файла database/performance_optimization.sql"
echo "5. Выполните запрос"

echo ""
log_info "Содержимое файла для копирования:"
echo "----------------------------------------"
cat database/performance_optimization.sql
echo "----------------------------------------"
